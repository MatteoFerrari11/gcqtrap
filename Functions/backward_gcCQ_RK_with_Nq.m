function g_n = backward_gcCQ_RK_with_Nq(phi,K_op,t,RK,Nq)
...
% the difference with backward_gcCQ_RK_with is that here Nq is an input
...
%      - Nq : number of quadrature points for the complex integration
